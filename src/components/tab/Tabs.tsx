...
export const Tabs = () => {
    ...
    return (
        <div className="Tabs">
            {/* Tab nav */}
            <ul className="nav">
                <li className={activeTab === 'defaultProductsTab' ? 'active' : ''} onClick={handleTab1}>
                    <h1>Продукти</h1>
                </li>
                <li className={activeTab === 'selectedProductsTab' ? 'active' : ''} onClick={handleTab2}>
                    <h1>Избрани</h1>
                </li>
            </ul>
            <div className="outlet">{activeTab === 'defaultProductsTab' ? <DefaultProductsTab /> : <SelectedProductsTab />}</div>
        </div>
    );
};
